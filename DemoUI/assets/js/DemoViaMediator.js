             ...
             new Promise( function(resolve, reject) {
                ...
                $.each(ajaxResponse.data.data,   function(key,value) {
                    ...
                    if(value.detailData !=null && value.detailData!=undefined && 
                        ...
                        value.detailData.father[0] !=null && value.detailData.father[0] !=undefined && 
                        value.detailData.father[0].firstNames !=null && value.detailData.father[0].firstNames !=undefined ) {
                            fatherName =  value.detailData.father[0].firstNames;
                    }
                    if(value.detailData !=null && value.detailData!=undefined && 
                        value.detailData.mother !=null && value.detailData.mother!=undefined && 
                        value.detailData.mother[0] !=null && value.detailData.mother[0] !=undefined && 
                        value.detailData.mother[0].firstNames !=null && value.detailData.mother[0].firstNames !=undefined ) {
                            motherName =  value.detailData.mother[0].firstNames;
                    }
                if(value.type == "Death"){
